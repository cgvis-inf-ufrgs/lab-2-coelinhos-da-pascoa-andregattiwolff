...
- **Cartão UFRGS**: <mark>`578039`</mark>
- **Nome**: <mark>`André Gatti Wolff`</mark>
...
<mark>`1. Adicione mais uma esfera para o coelho. Ela deve y oposto à outra.
        2. Faça com que os ovos orbitem no eixo X em relação ao centro do coelho.
        3. Adicione mais coelhos e os distribuia em um círculo. Os ângulos entre coelhos deve ser em relação ao numero total de coelhos A posição X é em relação ao cos e a posição Z em relação ao sen desse ângulo.
        4. Os coelhos devem subir e descer em função senoidal. Y inicial é fixo.
        5. Ajustar variações de senos e cosenos, tamanhos dos circulos, coelhos e ovos para aproximar ao exemplo.>
        6. Aumentar o tamanho do plano, a distância inicial da câmera e far plane para caber tudo e nada desaparecer ao fundo.`</mark>

## Principais dificuldades encontradas durante o desenvolvimento (formato livre)

<mark>`Encontrar as variações das funções senoides e também me confundo frequentemente entre qual eixo preciso rotacionar`</mark>

## Você acha que conseguiu resolver o problema de forma adequada?

<mark>`Acho que sim`</mark>
